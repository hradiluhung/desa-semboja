...
export default function Page() {
  ...
  async function handleUpload(e) {
    ...
    try {
      ...
      const resCreatePost = await axios.post("/api/posts", {
        title: post.title,
        author: post.author,
      ...
      console.log(resCreatePost.data);
      setIsLoading(false);
  ...
  return (
    <div className="create-post">
      <div className="create-post__heading">
        <span className="create-post__title">Buat Kabar</span>
      ...
      >
        ...
        <div className="create-post__input-container">
          <label className="create-post__label">Gambar</label>
          <input
            className="create-post__input"
            type="file"
            accept="image/*"
          ...
          />
          {file && (
            <div className="create-post__preview-image-container">
              <Image
              ...
              />
              <button
                className="create-post__preview-image-delete"
                onClick={() => {
                  setFile(null);
